...
### Содержимое RFID карты или NFC метки

### Алгоритм формирования хеша для карты
```
CARD_CYPHER = crypto (
  CARD_ID
  + TRANSPORT_ID
...
![Scheme database_server][database_server]

### База данных на Raspberry PI

![Scheme database_client][database_client]

## Server ER Diagram

## Raspberry PI ER Diagram
...
[database_server]: schemes/database_server.png "database_server"
[database_client]: schemes/database_client.png "database_client"
